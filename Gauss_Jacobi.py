{
  ...
  "metadata": {
    "colab": {
      "name": "Gauss_Jacobi",
      "provenance": [],
      "authorship_tag": "ABX9TyMY4vhIUZyNDai+kVwfW+Sl",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/lucasdonizete/MetodosNumericos/blob/master/Gauss_Jacobi.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
